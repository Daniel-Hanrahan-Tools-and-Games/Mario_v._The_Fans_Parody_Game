...
void trap() {
    ...
    if (intEscapeVariable > intTrapIntellegence) {
       printf("1 escaped the trap. \n");
    }
    else {
        printf("1 did not escape the trap, Game Over") ;
        exit(0);
    }
...
void enemy() {
    ...
    switch (intEnemyType) {
        case 1:
            printf("You have encountered a 2, what will you do, 0:attack, 1:Talk: ");
            scanf("%s", &charAction);
            break;
        case 2:
            printf("You have encountered a 2, what will you do, 0:attack, 1:Talk: ");
...
int main() {
    ...
    printf("\n");
    // Copyright Notice
    printf("Copyright (C) 2026 Daniel Hanrahan Tools and Games \n");
    // Spacing out Info
    printf("\n");
    // Parody Notice
    printf("Warning: This Game uses Characters in a Satarical, Parodic and Fictitious manner which falls under fair use, we are not affilated with the creators of those characters or anyone affiliated with the creators of those characters, unless we created them and this game comes with no/0 copyrighted material other than our own, so you/The Player would have to get your own copyrighted material legally, The Players own characters will become those characters. \n");
    // Spacing out Info
    printf("\n");

    // characters relationship input
    printf("What is the Characters who will become 1s relationship(1.Married, 2.General Romantic, 3.Other): ");
    ...
    printf("Enter first character who will become 1s name: ");
    ...
    printf("Enter second character who will become 1s name: ");
